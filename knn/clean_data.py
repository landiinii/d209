...
def CorrectNulls(df):
    ...
    df.dropna(subset=['Churn', 'Marital', 'Gender', 'Area'])
...
def CorrectNumericOutliers(df):
    ...
    for c in ['Children','Age','Income','Outage_sec_perweek','Email','Contacts','Yearly_equip_failure']:
...
# Cleaning
columns = ['Churn','Area','Children','Age','Income','Marital','Gender','Techie',
